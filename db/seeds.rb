...
bob = User.create(firstName: 'Bob', lastName: 'Smit', company: 'Amazon', bio: 'Five years as a SWE. Happy to share my knowledge!', role: 'mentor', email: 'bob@email.com', password: '123456')
...
Post.create(user_id: bob.id, content: "First post!")

Post.create(user_id: anna.id, content: "Is this how you make a post?")